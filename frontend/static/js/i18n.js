window.I18n = (() => {
  ...
  const messages = {
    en: {
      ...
      "settings.turnaround": "Turnaround (FLUX Kontext)",
      "settings.turnaroundHint": "5-view character turnaround sheet — sent to FLUX Kontext with 16:9 aspect.",
      "settings.kontext3d": "3D Pixar (FLUX Kontext)",
      "settings.kontext3dHint": "Used for legacy-3d mode only.",
    ...
    ru: {
      ...
      "settings.turnaround": "Turnaround (FLUX Kontext)",
      "settings.turnaroundHint": "5-видовой лист turnaround — отправляется в FLUX Kontext (16:9).",
      "settings.kontext3d": "3D Pixar (FLUX Kontext)",
    ...
    ka: {
      ...
      "settings.turnaround": "Turnaround (FLUX Kontext)",
      "settings.turnaroundHint": "5-ხედიანი turnaround — FLUX Kontext-ში 16:9 ფორმატით.",
      "settings.kontext3d": "3D Pixar (FLUX Kontext)",
