...
DEFAULT_PROMPTS = {
    "PRODUCT_REFERENCE_PROMPT": AIService.PRODUCT_REFERENCE_PROMPT,
    "STYLE_GUIDED_PROMPT": AIService.STYLE_GUIDED_PROMPT,
    "TURNAROUND_PROMPT": AIService.TURNAROUND_PROMPT,
